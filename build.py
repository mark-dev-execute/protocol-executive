...
FOOTER = [
    ...
    ("Company", [
        ...
        ("Reviews", "reviews/"),
        ("Guides", "guides/"),
        ("Interview questions guide", "guides/interview-questions/"),
        ("Google interview guide", "guides/google-interview/"),
        ("Pricing", "pricing/"),
        ("Programs", "programs/"),
...
FOOTER_ES = [
    ...
    ("Más, en inglés", [
        ...
        ("Opiniones", "reviews/"),
        ("Guías", "guides/"),
        ("Guía de preguntas de entrevista", "guides/interview-questions/"),
        ("Guía de la entrevista de Google", "guides/google-interview/"),
        ("Coaching de entrevistas técnicas", "tech-interview-coaching/"),
        ("Coaching de carrera", "career-coaching/"),
